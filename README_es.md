...
- **SPGExtended**: 448 documentos extendidos del SPG (358 train, 45 dev, 45 test)
...
- **`results_dev.xlsx`**: Métricas de evaluación en conjunto de desarrollo
- **`results_test.xlsx`**: Métricas de evaluación en conjunto de prueba
